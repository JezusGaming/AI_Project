...
Controlled::Controlled()
{
	...
	m_behaviours.PushFront(new KeyboardBehaviour(1.0f));
	m_behaviours.PushFront(new Flee(0.8f));
}
...
//		
//----------------------------------------------------------------------------
void Controlled::OnUpdate(float deltaTime, Agent * agent, AIStateMachine * pMachine)
{
